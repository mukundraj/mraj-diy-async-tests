...
inline float texel2D(const float *ptr,
                     const int   *sz,
                     int         x,
                     int         y);
inline float texel3D(const float *ptr,
                     const int   *sz,
                     int         x,
                     int         y,
                     int         z);
inline float texel4D(const float *ptr,
                     const int   *sz,
                     int         x,
                     int         y,
                     int         z,
...
inline bool lerp2D(const float *pt,
                   ...
                   const float **ptrs,
                   float       *vars);
inline bool lerp3D(const float *pt,
                   const int   *st,
                   const int   *sz,
                   int         num_vars,
                   const float **ptrs,
                   ...
                   float *vars)              // output interpolated vector at target point
{
    ...
    float x  = pt[0] - st[0],                // physical coords of point relative to min. of block
          y  = pt[1] - st[1],
          z  = pt[2] - st[2];
